...
ev("state=defaultState(); normalizeState(); state.combatXp={};"+
   ...
   "state.items={sundershaft:100000};");
...
const bowEq=id=>`{weapon:'${id}',quiver:'sundershaft',helm:'sunweave_helm',chest:'sunweave_chest',legs:'sunweave_legs',boots:'sunweave_boots',gloves:'stonewright_gauntlets'}`;
...
for(const [id,label] of [['sunpiercer','Sunpiercer'],['plummet','Plummet']]){
  ...
  for(const [a,s] of [[cur.atk,cur.str],[88,42],[84,38],[80,34],[76,30]]){
    const r=test(id,a,s);

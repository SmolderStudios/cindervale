...
**Batches 1 and 2 below are written for SwarmUI.** Jordan works in ChatGPT, so
they need turning into contact sheets before they are usable. Ask for it.
...
The nine Spire natives are **Sheet D in `PROMPTS-spire.md`**, as a ChatGPT contact
sheet. They were briefly written here for SwarmUI, which is the wrong tool: every
item icon in the game came off ChatGPT sheets, and Swarm cannot draw icons that
read at 20px.
